...
namespace Together_Culture__Dream_Team_.Back_End.Src.Main
{
    internal class DatabaseConnect : IDisposable
    {
        ...
        public DatabaseConnect()
        {
            ...
            string connectionString = $@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\manas\OneDrive\Documents\seema\test\Together Culture (Dream Team)\Database\db_TogetherCulture.mdf"";Integrated Security=True;Connect Timeout=30";
