...
namespace Together_Culture__Dream_Team_.Back_End.Src.Main
{
    public class DatabaseConnect : IDisposable
    {
        ...
        public DatabaseConnect()
        {
            ...
            string connectionString = $@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\USERS\PC\SOURCE\REPOS\DREAM-TEAM\TOGETHER CULTURE (DREAM TEAM)\DATABASE\DB_TOGETHERCULTURE.MDF"";Integrated Security=True;Connect Timeout=30";
