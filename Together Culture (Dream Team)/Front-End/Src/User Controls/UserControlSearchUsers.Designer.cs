namespace Together_Culture__Dream_Team_.Front_End.Src.User_Controls
{
    partial class UserControlSearchUsers
    {
        ...
        private void InitializeComponent()
        {
            ...
            selectAllRadioBtn.Font = new Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
            selectAllRadioBtn.Location = new Point(45, 28);
            selectAllRadioBtn.Name = "selectAllRadioBtn";
            selectAllRadioBtn.Size = new Size(122, 34);
            selectAllRadioBtn.TabIndex = 0;
            selectAllRadioBtn.TabStop = true;
            selectAllRadioBtn.Text = "Select All";
            selectAllRadioBtn.UseVisualStyleBackColor = false;
            // 
